...
// ReadCommitted provides a mock function with given fields: ctx, fn
func (_m *MockTxManager) ReadCommitted(ctx context.Context, fn func(context.Context) error) error {
...
func (_c *MockTxManager_ReadCommitted_Call) Run(run func(ctx context.Context, fn func(context.Context) error)) *MockTxManager_ReadCommitted_Call {
...
// RepeatableRead provides a mock function with given fields: ctx, fn
func (_m *MockTxManager) RepeatableRead(ctx context.Context, fn func(context.Context) error) error {
	ret := _m.Called(ctx, fn)
...
func (_c *MockTxManager_RepeatableRead_Call) Run(run func(ctx context.Context, fn func(context.Context) error)) *MockTxManager_RepeatableRead_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(context.Context) error))
	})
	return _c
...
func (_c *MockTxManager_RepeatableRead_Call) Return(_a0 error) *MockTxManager_RepeatableRead_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTxManager_RepeatableRead_Call) RunAndReturn(run func(context.Context, func(context.Context) error) error) *MockTxManager_RepeatableRead_Call {
	_c.Call.Return(run)
	return _c
}
