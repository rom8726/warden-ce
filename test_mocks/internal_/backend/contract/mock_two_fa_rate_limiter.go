...
// Inc provides a mock function with given fields: userID
func (_m *MockTwoFARateLimiter) Inc(userID domain.UserID) (int, bool) {
	...
	var r0 int
	var r1 bool
	if rf, ok := ret.Get(0).(func(domain.UserID) (int, bool)); ok {
		return rf(userID)
	}
	if rf, ok := ret.Get(0).(func(domain.UserID) int); ok {
		r0 = rf(userID)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(domain.UserID) bool); ok {
		r1 = rf(userID)
	} else {
		r1 = ret.Get(1).(bool)
	}
...
func (_c *MockTwoFARateLimiter_Inc_Call) RunAndReturn(run func(domain.UserID) (int, bool)) *MockTwoFARateLimiter_Inc_Call {
	_c.Call.Return(run)
	return _c
}

// IsBlocked provides a mock function with given fields: userID
func (_m *MockTwoFARateLimiter) IsBlocked(userID domain.UserID) bool {
	ret := _m.Called(userID)
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(domain.UserID) bool); ok {
		r0 = rf(userID)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *MockTwoFARateLimiter_IsBlocked_Call) Return(_a0 bool) *MockTwoFARateLimiter_IsBlocked_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTwoFARateLimiter_IsBlocked_Call) RunAndReturn(run func(domain.UserID) bool) *MockTwoFARateLimiter_IsBlocked_Call {
	_c.Call.Return(run)
	return _c
}

// Reset provides a mock function with given fields: userID
func (_m *MockTwoFARateLimiter) Reset(userID domain.UserID) {
	_m.Called(userID)
}
...
func (_c *MockTwoFARateLimiter_Reset_Call) RunAndReturn(run func(domain.UserID)) *MockTwoFARateLimiter_Reset_Call {
	_c.Run(run)
	return _c
}
