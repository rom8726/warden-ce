...
import (
	...
	_ "github.com/golang-migrate/migrate/v4/source/file" //nolint:revive // it's ok
	_ "github.com/lib/pq"                                //nolint:revive // it's ok
)

func upPostgresMigrations(connStr, migrationsDir string) error {
	slog.Info("up postgres migrations...")
